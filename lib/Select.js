...
var Select = React.createClass({
	...
	propTypes: {
		...
		keepOpenOnSelect: React.PropTypes.bool, // if the Select should stay open after the user selects a value
   ...
   */
	...
	handleInputBlur: function handleInputBlur(event) {
		...
		// only resets the value if there are no selected values and if there were no previous selections made
		if (this.state.value === "" && !this.state.options.find(o => o.label === this.state.placeholder)) {
