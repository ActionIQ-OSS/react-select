...
var Select = React.createClass({
   ...
   */
	...
	isValuePropEmpty: function isValuePropEmpty() {
		// checks to see if the value prop, which is could be anything is empty
		const { value, multi } = this.props;
		if (value.constructor === Array && multi) {
