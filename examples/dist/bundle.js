...
},{"classnames":undefined,"create-react-class":2,"prop-types":11,"react":undefined}],14:[function(require,module,exports){
'use strict';
...
},{"classnames":undefined,"create-react-class":2,"prop-types":11,"react":undefined}],15:[function(require,module,exports){
'use strict';
...
},{"classnames":undefined,"create-react-class":2,"prop-types":11,"react":undefined}],"react-select":[function(require,module,exports){
...
var Select = createReactClass({
	...
	propTypes: {
		...
		shouldKeyDownEventCreateNewOption: PropTypes.func, // function check whether a key should permit creating a new option: function(event) => bool
	...
	render: function render() {
		...
		if (!this.props.disabled) {
			if (this.props.searchable) {
				input = React.createElement(_reactInputAutosize2['default'], _extends({ value: this.state.inputValue, onChange: this.handleInputChange, minWidth: '5' }, inputProps));
			} else {
